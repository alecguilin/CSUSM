...
#Create a CBR generator for each traffic source and attach it to its apropriate agent
...
#Create a LossMonitor agent for each traffic and attach it to the end nodes
